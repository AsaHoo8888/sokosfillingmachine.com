...
const lineSteps = [
  {
    phase: "PHASE 01",
    title: "Depalletizer",
    text: "Automatic empty bottle depalletizing feeds cans or glass bottles into the line with stable layer handling and continuous output.",
    image: "/images/products/beer-line-depalletizer.jpg",
  },
  {
    phase: "PHASE 02",
    title: "Beer Filling Machine",
    text: "Isobaric filling and capping technology helps preserve carbonation, reduce oxygen pickup, and maintain beer flavor stability.",
    image: "/images/products/beer-line-filling-machine.jpg",
  },
  {
    phase: "PHASE 03",
    title: "Labeling Machine",
    text: "Automatic labeling keeps bottle or can presentation consistent with precise positioning at production speed.",
    image: "/images/products/beer-line-labeling-machine.jpg",
  },
  {
    phase: "PHASE 04",
    title: "Carton Packing Machine",
    text: "Automatic carton forming, product loading, and sealing prepares finished beer packs for transport and retail handling.",
...
const specs = [
  ["BDCGF18-18-6", "3,000 - 5,000", "18-18-6", "5.5 kW", "0.6 m3/min"],
  ["BDCGF24-24-8", "6,000 - 8,000", "24-24-8", "7.5 kW", "0.8 m3/min"],
  ["BDCGF32-32-10", "10,000 - 12,000", "32-32-10", "11.0 kW", "1.0 m3/min"],
  ["BDCGF40-40-12", "14,000 - 16,000", "40-40-12", "15.0 kW", "1.2 m3/min"],
];

const projects = [
  {
    place: "MEXICO, GUADALAJARA",
    title: "8,000 BPH Beer Line",
    text: "Integrated depalletizing, isobaric filling, labeling, carton packing, and palletizing for beer production.",
    year: "Est. 2022",
    image:
  ...
  {
    place: "VIETNAM, HCMC",
    title: "Compact Craft Beer System",
    text: "Designed for oxygen-controlled filling and compact end-of-line packing in a growing brewery.",
    year: "Est. 2023",
    image:
  ...
  },
  {
    ...
    title: "Multi-Format Beer Line",
    text: "Flexible configuration handling glass bottles and cans with carbonation-preserving filling and rapid changeover.",
    year: "Est. 2021",
    image:
...
export default function BeerFillingLinePage() {
  return (
      ...
      <div className="mx-auto min-h-screen max-w-[2000px] bg-white shadow-sm">
        ...
        <section className="relative overflow-hidden px-5 pb-24 pt-40 md:px-16 lg:pb-[120px]">
          <div
            ...
            style={{ backgroundImage: "url('/images/solutions/beer-line.jpg')" }}
          />
          ...
          <div className="relative mx-auto max-w-[1200px]">
            <div className="max-w-2xl">
              ...
              <p className="mb-10 max-w-xl text-lg leading-8 text-slate-600">
                Engineered for oxygen-controlled beer filling, stable carbonation, and efficient
                end-of-line packing. From depalletizing to palletizing, each module is configured
                for reliable brewery production.
              </p>
          ...
          <div className="mx-auto max-w-[1200px] px-5 md:px-16">
            <div className="mb-16 grid grid-cols-1 gap-8 lg:grid-cols-[0.85fr_1fr] lg:items-end">
              ...
              <p className="max-w-2xl text-base leading-7 text-slate-600">
                A complete beer filling line connects depalletizing, isobaric filling, labeling,
                carton packing, and palletizing into one continuous production system. Each module
                is configured around container type, carbonation level, factory layout, and output target.
              </p>
            </div>
        ...
        <section className="industrial-grid bg-white py-24 lg:py-[120px]">
          <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-6 px-5 md:grid-cols-3 md:px-16">
            ...
            <article className="bg-primary p-10 text-white shadow-md">
              ...
              <h3 className="mb-6 text-2xl font-bold text-white">Oxygen-Controlled Filling</h3>
            ...
            <article className="border border-[#e2e8f0] bg-white p-10 shadow-sm">
              ...
              <p className="mb-6 leading-7 text-slate-600">
                Servo-driven conveying and filling systems reduce energy use while keeping
                beer transfer stable and gentle.
              </p>
            ...
            <article className="flex flex-col gap-10 border border-[#e2e8f0] bg-white p-10 shadow-sm md:col-span-2 md:flex-row md:items-center">
              <div className="flex-1">
                ...
                <p className="leading-7 text-slate-600">
                  ...
                  bottle or can sizes, closure formats, and carton packing layouts with minimal downtime.
                </p>
              </div>
          ...
          <div className="mx-auto max-w-[1200px] px-5 md:px-16">
            <div className="mb-12">
              ...
              <p className="max-w-2xl text-lg leading-8 text-slate-600">
                Watch complete beer filling and packaging lines in action, demonstrating
                oxygen-controlled filling, clean labeling, carton packing, and palletizing efficiency.
              </p>
            </div>
            <Link
              aria-label="Watch beer filling line video"
              className="group relative block aspect-video w-full overflow-hidden border border-[#e2e8f0]"
              href="https://www.youtube.com/watch?v=y5Orw6k5ycE"
              rel="noreferrer"
              target="_blank"
            >
              <img
                ...
                src="/images/solutions/beer-line.jpg"
              />
