...
const lineSteps = [
  {
    ...
    text: "RO purification and UV or ozone sterilization preparing stable process water for carbonated drinks.",
    image: "/images/products/water-treatment-system.png",
  },
  {
    phase: "PHASE 02",
    title: "CO2 Mixer",
    text: "Horizontal CO2 mixing system for accurate syrup, water, and carbonation blending before filling.",
    image: "/images/products/co2-mixer.jpg",
  },
  {
    phase: "PHASE 03",
    title: "Blow Molding",
    text: "High-pressure rotary stretch molding for PET bottle consistency.",
    image: "/images/products/blow-molding-machine.jpg",
  },
  {
    phase: "PHASE 04",
    title: "3-in-1 Filling",
    text: "Rinsing, isobaric filling, and capping integrated into one high-stability carbonated drink unit.",
  ...
  },
  {
    phase: "PHASE 06",
    title: "Film Wrapping",
    text: "Automatic film wrapping or carton packing for global shipping.",
    image: "/images/products/packaging-system-wrapper.jpg",
  },
];

const specs = [
  ["DCGF14-12-5", "2,000 - 3,000", "14-12-5", "3.5 kW", "0.4 m3/min"],
  ["DCGF24-24-8", "8,000 - 10,000", "24-24-8", "4.8 kW", "0.6 m3/min"],
  ["DCGF32-32-10", "12,000 - 15,000", "32-32-10", "7.5 kW", "0.8 m3/min"],
  ["DCGF50-50-15", "20,000 - 24,000", "50-50-15", "11.0 kW", "1.2 m3/min"],
];

const projects = [
  {
    place: "ETHIOPIA, ADDIS ABABA",
    title: "16,000 BPH Carbonated Drink Line",
    text: "Full integration from process water treatment and isobaric filling to labeling and final packing.",
    year: "Est. 2022",
    image:
  ...
  {
    place: "UAE, DUBAI",
    title: "12,000 BPH Sparkling Water Line",
    text: "Designed for stable carbonation retention with compact layout and high-efficiency labeling modules.",
    year: "Est. 2023",
    image:
  ...
  },
  {
    ...
    title: "Multi-Format Soft Drink Line",
...
export default function CarbonatedDrinkFillingLinePage() {
  return (
      ...
      <div className="mx-auto min-h-screen max-w-[2000px] bg-white shadow-sm">
        ...
        <section className="relative overflow-hidden px-5 pb-24 pt-40 md:px-16 lg:pb-[120px]">
          <div
            ...
            style={{ backgroundImage: "url('/images/solutions/csd-line.png')" }}
          />
          ...
          <div className="relative mx-auto max-w-[1200px]">
            <div className="max-w-2xl">
              ...
              <p className="mb-10 max-w-xl text-lg leading-8 text-slate-600">
                Engineered for stable CO2 retention, clean filling, and peak operational
                efficiency. From 2,000 to 24,000 BPH, our turnkey lines integrate isobaric
                filling technology with industrial-grade automation.
              </p>
          ...
          <div className="mx-auto max-w-[1200px] px-5 md:px-16">
            <div className="mb-16 grid grid-cols-1 gap-8 lg:grid-cols-[0.85fr_1fr] lg:items-end">
              ...
              <p className="max-w-2xl text-base leading-7 text-slate-600">
                A complete carbonated drink filling line connects water treatment, bottle forming,
                isobaric filling, labeling, and final packaging into one continuous production
                system. Each module is configured around capacity, bottle type, factory layout,
                and carbonation stability.
              </p>
            </div>
          ...
          <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-6 px-5 md:grid-cols-3 md:px-16">
            <article className="border border-[#e2e8f0] bg-white/80 p-10 shadow-sm backdrop-blur md:col-span-2">
              ...
              <p className="mb-8 max-w-md text-lg leading-8 text-slate-600">
                Siemens PLC integration allows real-time pressure monitoring, adaptive speed
                control, and stable CO2 retention across high-speed production.
              </p>
            ...
            <article className="border border-[#e2e8f0] bg-white p-10 shadow-sm">
              ...
              <p className="mb-6 leading-7 text-slate-600">
                Optimized pressure control and servo-driven motors reduce power consumption by
            ...
            <article className="flex flex-col gap-10 border border-[#e2e8f0] bg-white p-10 shadow-sm md:col-span-2 md:flex-row md:items-center">
              <div className="flex-1">
                ...
                <p className="leading-7 text-slate-600">
                  ...
                  sparkling water to soft drinks or mixed beverage applications with minimal
                  downtime.
                </p>
              </div>
          ...
          <div className="mx-auto max-w-[1200px] px-5 md:px-16">
            <div className="mb-12">
              ...
              <p className="max-w-2xl text-lg leading-8 text-slate-600">
                Watch our complete carbonated drink filling and packaging lines in action,
                demonstrating isobaric filling stability and high-speed efficiency.
              </p>
            </div>
            <Link
              aria-label="Watch carbonated drink filling line video"
              className="group relative block aspect-video w-full overflow-hidden border border-[#e2e8f0]"
              href="https://youtu.be/hgHOXGUHOOc"
              rel="noreferrer"
              target="_blank"
            >
              <img
                ...
                src="/images/solutions/csd-line.png"
              />
